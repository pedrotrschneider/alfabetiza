...
const CACHE_NAME = "Alfabetiza-cache";
const OFFLINE_URL = "Alfabetiza.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Alfabetiza.html","Alfabetiza.js","Alfabetiza.wasm","Alfabetiza.pck","Alfabetiza.offline.html","Alfabetiza.icon.png","Alfabetiza.apple-touch-icon.png"];
